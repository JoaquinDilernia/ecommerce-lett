          ...
          {cart.map((product) => (
            <div className="producto" key={product.id}>
              ...
              <div className="informacion">
                ...
                {tipocliente() === 1 ? (
                  <p>${product.comercio * product.quantity}</p>
                ) : null}
                {tipocliente() === 2 ? (
                  <p>${product.walmart * product.quantity}</p>
                ) : null}
                {tipocliente() === 3 ? (
                  <p>${product.grandes * product.quantity}</p>
                ) : null}
                {tipocliente() === 4 ? (
                  <p>${product.morph * product.quantity}</p>
                ) : null}
                {tipocliente() === 5 ? (
                  <p>${product.prestigio * product.quantity}</p>
                ) : null}
